...
def is_word_guessed(secret_word, letters_guessed):
        ...
        returns: boolean, True if all the letter of secret_word are in letters_guessed;
        False otherwise
        '''
        # FILL IN YOUR CODE HERE...
        """
        for every letter in secret word
        if letter is not in the letters_guessed
            return false
        return true
        """
...
def get_guessed_word(secret_word, letters_guessed):
        ...
        secret_word: string, the word the user is guessing
        letters_guessed: list, what letters have been guessed so far
        returns: string, comprised of letter and underscores that represents
        what letter in secret_word have been guessed so far.
        '''
        # FILL IN YOUR CODE HERE...
        '''
...
def get_available_letters(letters_guessed):
        '''
        letters_guessed: list, what letter have been guessed so far
        returns: string, comprised of letter that represents what letter have not yet been guessed.
        '''
